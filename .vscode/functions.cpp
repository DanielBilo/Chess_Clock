...
void displayClock(unsigned long timeLeft, unsigned long timeRight)
 {  
    ...
    unsigned long ms = (timeLeft - (3600000 * hours) - (60000 * minutes) - (seconds * 1000));
    ...
    else
    {
        ...
        max7219.DisplayChar(7, 48 + ((ms % 100) / 10), 0);             //48 is ASCII value for 0 
    }

    hours = timeRight / (60 * 60000);
    minutes = ((timeRight / 1000) - (3600 * hours)) / 60; 
    seconds = ((timeRight / 1000) - (3600 * hours) - (minutes * 60));
    ms = (timeRight - (3600000 * hours) - (60000 * minutes) - (seconds * 1000));
